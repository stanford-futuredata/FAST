...
in_real_phase_file = 'event_picks.json'
# out_hinv_phase_file = 'EQT_20180101_20220101_test.phs'
...
with open(in_real_phase_file, 'r') as freal:
   ...
   for i in json_data['SeisBench_Picks']:
      ...
      if json_data['SeisBench_Picks'][ev_id]['P_Origin_Time'] != ' ':
         ...
         # json_origin_time = UTCDateTime(json_data['SeisBench_Picks'][ev_id]['P_Origin_Time'])
         # year = json_origin_time.year
         # month = json_origin_time.month
         # day = json_origin_time.day
         # hour = json_origin_time.hour
         # minute = json_origin_time.minute
               ...
               if j != 'P_Origin_Time':
                  ...
                  if len(json_data['SeisBench_Picks'][ev_id][j]) > 0:
                     for k in range(len(json_data['SeisBench_Picks'][ev_id][j])):
                           ...
                           # ph = picks['SeisBench_Picks'][ev_id][i][j]['phase']
                           # print(ph)
