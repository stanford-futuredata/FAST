function [detection_out] = make_detection_list(topdata, thresh_cc, skip_samples)

% Input is 'topdata' generated from calling mxRemoveDuplicatePairs() or remove_duplicates.m
...
preallocsize = 600000; % max number of detections
