...
for it,start_time in enumerate(start_times):
   ...
   #plt.show()
   #plt.savefig(input_dir+'waveform10s_'+str(start_time)+'.png')
   #plt.savefig(input_dir+'pwave_'+str(start_time)+'.png')
   plt.savefig(input_dir+'pwave_'+str(start_time)+'.eps')
   plt.clf()
   ...
   #plt.show()
   #plt.savefig(input_dir+'particlemotion_'+str(start_time)+'.png')
   plt.savefig(input_dir+'particlemotion_'+str(start_time)+'.eps')
   #plt.savefig(input_dir+'particlemotion10samples_'+str(start_time)+'.png')
   #plt.clf()
