...
% Data directory
data_dir = '../../../data/OutputFAST/NCSN_CCOB_EHN_1wk/';
...
% time_window = 21.0;
% skip_samples = round(time_window/dt_fp);
% [detdata.cc_i, detdata.cc_j, detdata.cc] = mxRemoveDuplicatePairs(detdata.pair_i, detdata.pair_j, detdata.pair_k, skip_samples);
