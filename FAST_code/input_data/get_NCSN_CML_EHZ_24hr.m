function [t, x, Fs] = get_NCSN_CML_EHZ_24hr()

% Read in data from NCSN, station CML.EHZ, 24 hours, decimated 5 times
path(path,'./MatSAC');
% [t,x,SAChdr] = fget_sac('../data/ncsn/2011.008.00.00.00.deci5.24hr.NC.CML.EHZ.D.SAC.bp2to10');
[t,x,SAChdr] = fget_sac('../data/ncsn/2011.008.00.00.00.deci5.24hr.NC.CML.EHZ.D.SAC.bp2to6');
Fs = 20;
