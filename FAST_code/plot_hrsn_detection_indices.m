...
fileName = 'detdata_wLen6_wLag0.05_fpLen64_fpLag10_tvalue200_nfuncs5_ntbls100_nvotes4.mat';
...
out_dir = './outputs/HRSN_detections_20060509_24hr/';
...
for ifile=1:length(folderStr)
    ...
    outfile = [out_dir 'single_channel_' folderStr{ifile} '_fpss_detections.png'];
    print('-dpng', outfile);
end
