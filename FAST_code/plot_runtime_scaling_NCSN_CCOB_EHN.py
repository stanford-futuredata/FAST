...
plt.savefig('NCSN_CCOB_EHN_runtime_breakdown.png')
...
plt.savefig('NCSN_CCOB_EHN_runtime_vs_data_duration.png')
...
plt.xlim([0.8, 300])
plt.title('Runtime, NCSN CCOB.EHN')
plt.savefig('loglog_NCSN_CCOB_EHN_runtime_breakdown.png')
...
plt.savefig('loglog_NCSN_CCOB_EHN_runtime_vs_data_duration.png')
...
plt.title('Runtime vs. Continuous data duration')
plt.savefig('logset_NCSN_CCOB_EHN_runtime_vs_data_duration.png')
...
plt.savefig('NCSN_CCOB_EHN_memory_vs_data_duration.png')
...
plt.savefig('loglog_NCSN_CCOB_EHN_memory_vs_data_duration.png')
...
#plt.savefig('20100701_Guy_memory_usage.png')
#
#plt.figure(1)
...
#plt.savefig('20100701_Guy_search_runtime.png')
##plt.show()
