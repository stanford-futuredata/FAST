...
function [binaryFingerprint, dt_fp] = time_window_fingerprint_uniform(x, samplingRate, varargin)
...
%%% Uniform fingerprint test - first fingerprint
uniformFP = false(num_ampl, windowLength);
uniformFP((num_ampl+1)/2, :) = true;
binaryFingerprint(:,1) = reshape(uniformFP, numbits, 1);
