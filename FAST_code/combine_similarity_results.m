...
[simData, baseDir, outFolder, paramStr, nfp, dt, thresh] = get_total_similarity_inputs();
...
output_flag = 1;
if (output_flag)
    outDataStr = strcat('fpss', paramStr, '_thresh', num2str(thresh), '.mat');
%     outDataStr = strcat('autocorr', paramStr, '_thresh', num2str(thresh), '.mat');
