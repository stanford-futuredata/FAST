...
% No time shift:
% [t, x.e, hdr.e] = fread_sac('../data/GuyArkansas/20100601_20100831_HHE_CustBP_1_30_bp1to20.SAC');
% [t, x.n, hdr.n] = fread_sac('../data/GuyArkansas/20100601_20100831_HHN_CustBP_1_30_bp1to20.SAC');
% [t, x.z, hdr.z] = fread_sac('../data/GuyArkansas/20100601_20100831_HHZ_CustBP_1_30_bp1to20.SAC');

% Time shift:
% [t, x.e, hdr.e] = fread_sac('../data/GuyArkansas/20100601_20100831_HHE_BP_1_30_bp1to20.SAC');
% [t, x.n, hdr.n] = fread_sac('../data/GuyArkansas/20100601_20100831_HHN_BP_1_30_bp1to20.SAC');
% [t, x.z, hdr.z] = fread_sac('../data/GuyArkansas/20100601_20100831_HHZ_BP_1_30_bp1to20.SAC');
...
savestr = 'notimeshift_pwave_';
% savestr = 'timeshift_pwave_';
