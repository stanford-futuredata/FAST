...
#define assert( isOK, error )        ( (isOK) ? (void)0 : (void) mexErrMsgTxt(error) )   
//-----------------------------------------------------------------------------
...
// Same as above, but for a block of keys
// nx       : Block dimension x (number of fingerprints)
// ny       : Block dimension y (size of fingerprint)
void MinHashMM_Block_32(const bool * block, int nx, int ny, int ntimes, uint32_t seed, void * out){
