...
% folder = '../data/haar_coefficients/NCSN_CCOB_EHN_1wk/';
% filename = 'fpss_wLen10_wLag0.1_fpLen100_fpLag10_tvalue800_nfuncs5_ntbls100_nvotes4_timewin21_thresh0.11.mat';
% filepath = strcat(folder, filename);
% load(filepath);
% dt = 1.0;
% thresh = 0.33; % FPSS threshold
% 
...
dir = '../data/haar_coefficients/NCSN_CCOB_EHN_1wk/';
