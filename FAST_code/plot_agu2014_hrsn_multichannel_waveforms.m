...
[t, x(:,1,3), samplingRate] = get_channel_data('HRSN_JCNB_BP3_20071026_24hr');
[t, x(:,2,3), samplingRate] = get_channel_data('HRSN_SMNB_BP3_20071026_24hr');
[t, x(:,3,3), samplingRate] = get_channel_data('HRSN_SCYB_BP3_20071026_24hr');

[t, x(:,1,2), samplingRate] = get_channel_data('HRSN_JCNB_BP2_20071026_24hr');
[t, x(:,2,2), samplingRate] = get_channel_data('HRSN_LCCB_BP2_20071026_24hr');
[t, x(:,3,2), samplingRate] = get_channel_data('HRSN_SMNB_BP2_20071026_24hr');
[t, x(:,4,2), samplingRate] = get_channel_data('HRSN_SCYB_BP2_20071026_24hr');
[t, x(:,5,2), samplingRate] = get_channel_data('HRSN_JCSB_BP2_20071026_24hr');

[t, x(:,1,1), samplingRate] = get_channel_data('HRSN_JCNB_BP1_20071026_24hr');
[t, x(:,2,1), samplingRate] = get_channel_data('HRSN_MMNB_BP1_20071026_24hr');
[t, x(:,3,1), samplingRate] = get_channel_data('HRSN_SMNB_BP1_20071026_24hr');
[t, x(:,4,1), samplingRate] = get_channel_data('HRSN_SCYB_BP1_20071026_24hr');
