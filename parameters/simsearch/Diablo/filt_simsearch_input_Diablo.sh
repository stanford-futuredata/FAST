...
STATION=${1:-PPB}
CHANNEL=${2:-EHZ}
PARTNUM=${3:-10} # number of partitions - input to be once per month for FREQ_NOISE

BASE_DIR=/lfs/1/ceyoon/TimeSeries/Diablo/waveforms${STATION}
...
NTHREAD=56
NUM_PART=${PARTNUM}
FREQ_NOISE=0.01 # 1% of matches per partition
echo "NTBLS="$NTBLS
echo "NHASH="$NHASH
