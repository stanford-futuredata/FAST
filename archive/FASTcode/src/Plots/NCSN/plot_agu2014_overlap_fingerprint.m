...
% load('../../../data/OutputFAST/NCSN_CADB_EHZ_24hr/binaryFingerprint_wLen10_wLag0.1_fpLen100_fpLag10_tvalue800.mat');
% load('../../../data/OutputFAST/NCSN_CAO_EHZ_24hr/binaryFingerprint_wLen10_wLag0.1_fpLen100_fpLag10_tvalue800.mat');
% load('../../../data/OutputFAST/NCSN_CHR_EHZ_24hr/binaryFingerprint_wLen10_wLag0.1_fpLen100_fpLag10_tvalue800.mat');
% load('../../../data/OutputFAST/NCSN_CML_EHZ_24hr/binaryFingerprint_wLen10_wLag0.1_fpLen100_fpLag10_tvalue800.mat');
...
fp1266.imageBinaryFp = reshape(binaryFingerprint(:,1266), ny, nx);
...
and_image = and(fp1266.imageBinaryFp, fp1629.imageBinaryFp);
figure
set(gca, 'FontSize', font_size)
imagesc(and_image);
set(gca, 'YDir', 'normal');
...
xor_image = xor(fp1266.imageBinaryFp, fp1629.imageBinaryFp);
figure
set(gca, 'FontSize', font_size)
imagesc(xor_image);
set(gca, 'YDir', 'normal');
...
title(['Binary Fingerprint Overlap']);
...
% jaccard
or_image = or(fp1266.imageBinaryFp, fp1629.imageBinaryFp);
