...
ncsn.detections = [58 58]; % [autocorrelation fast] number of detections
figure
bar(ncsn.detections);
...
hrsn.detections = [12 15; 10 20]; % [ac.eq ac.lfe; fast.eq fast.lfe] number of detections
figure
...
hrsn.runtimes = [hrsn.ac.total hrsn.runtime.total]/(3600*24); % [autocorrelation fast] runtime (days)
figure
bar(hrsn.runtimes, 'r');
set(gca, 'FontSize', 22, 'FontWeight', 'bold');
xlim([0.5 2.5]);
