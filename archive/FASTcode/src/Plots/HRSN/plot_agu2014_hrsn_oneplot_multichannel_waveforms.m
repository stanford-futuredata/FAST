...
[t, x(:,4), samplingRate] = get_channel_data(timeSeriesFile, 'HRSN_JCSB_BP2_20071026_24hr');
timeSeriesFile = '../../../data/TimeSeries/HRSN/2007.299.00.00.00.0058.BP.LCCB..BP2.Q.SAC.bp2to8';
[t, x(:,5), samplingRate] = get_channel_data(timeSeriesFile, 'HRSN_LCCB_BP2_20071026_24hr');
...
[t, x(:,7), samplingRate] = get_channel_data(timeSeriesFile, 'HRSN_SMNB_BP1_20071026_24hr');
timeSeriesFile = '../../../data/TimeSeries/HRSN/2007.299.00.00.00.0389.BP.SMNB..BP2.Q.SAC.bp2to8';
[t, x(:,8), samplingRate] = get_channel_data(timeSeriesFile, 'HRSN_SMNB_BP2_20071026_24hr');
timeSeriesFile = '../../../data/TimeSeries/HRSN/2007.299.00.00.00.0389.BP.SMNB..BP3.Q.SAC.bp2to8';
[t, x(:,9), samplingRate] = get_channel_data(timeSeriesFile, 'HRSN_SMNB_BP3_20071026_24hr');
timeSeriesFile = '../../../data/TimeSeries/HRSN/2007.299.00.00.00.0478.BP.SCYB..BP1.Q.SAC.bp2to8';
[t, x(:,10), samplingRate] = get_channel_data(timeSeriesFile, 'HRSN_SCYB_BP1_20071026_24hr');
timeSeriesFile = '../../../data/TimeSeries/HRSN/2007.299.00.00.00.0478.BP.SCYB..BP2.Q.SAC.bp2to8';
[t, x(:,11), samplingRate] = get_channel_data(timeSeriesFile, 'HRSN_SCYB_BP2_20071026_24hr');
timeSeriesFile = '../../../data/TimeSeries/HRSN/2007.299.00.00.00.0478.BP.SCYB..BP3.Q.SAC.bp2to8';
[t, x(:,12), samplingRate] = get_channel_data(timeSeriesFile, 'HRSN_SCYB_BP3_20071026_24hr');
