...
# Read detection times and magnitudes from compare_fast_*.txt files
# Guy, Arkansas: Matching, New, Missed Detections
# For now, run on cees-cluster
#input_dir = '../../data/OutputFAST/totalMatrix_WHAR_20101101_3ch_01hr/'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs5_ntbls100_nvotes2_thresh0.16_catalog_timewin4.txt'
#file_sac_HHE = '201011_HHE_BP_1_1_01_bp1to20.SAC'
#file_sac_HHN = '201011_HHN_BP_1_1_01_bp1to20.SAC'
#file_sac_HHZ = '201011_HHZ_BP_1_1_01_bp1to20.SAC'
#out_wv_dir = '/data/cees/ceyoon/multiple_components/haar_coefficients/totalMatrix_WHAR_20101101_3ch_01hr/'

#input_dir = '../../data/OutputFAST/totalMatrix_WHAR_20101101_3ch_24hr/'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs5_ntbls100_nvotes2_thresh0.15_catalog_timewin3.txt'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs5_ntbls100_nvotes2_thresh0.24_catalog_timewin3.txt'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs5_ntbls100_nvotes2_thresh0.24_catalog_timewin4.txt'
#file_sac_HHE = '201011_HHE_BP_1_1_bp1to20.SAC'
#file_sac_HHN = '201011_HHN_BP_1_1_bp1to20.SAC'
#file_sac_HHZ = '201011_HHZ_BP_1_1_bp1to20.SAC'
#out_wv_dir = '/data/cees/ceyoon/multiple_components/haar_coefficients/totalMatrix_WHAR_20101101_3ch_24hr/'

#input_dir = '../../data/OutputFAST/totalMatrix_WHAR_20100701_3ch_1wk/'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs6_ntbls100_nvotes2_thresh0.24_catalog_timewin4.txt'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs6_ntbls100_nvotes2_thresh0.32_catalog_timewin4.txt'
...
#input_dir = '../../data/OutputFAST/totalMatrix_WHAR_20100701_3ch_2wk/'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs6_ntbls100_nvotes4_thresh0.24_catalog_timewin4.txt'
...
#input_dir = '../../data/OutputFAST/totalMatrix_WHAR_20100701_3ch_1month/'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs8_ntbls100_nvotes4_thresh0.32_catalog_timewin4.txt'
...
input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs8_ntbls100_nvotes4_thresh0.33_catalog_timewin4.txt'
...
out_wv_dir = '../../data/OutputFAST/totalMatrix_WHAR_20100601_3ch_3month/waveforms/'
#out_wv_dir = '../../data/OutputFAST/totalMatrix_WHAR_20100601_3ch_3month/test_waveforms/'
#out_wv_dir = '../../data/OutputFAST/totalMatrix_WHAR_20100601_3ch_3month/SP_waveforms/'
#out_wv_dir = '../../data/OutputFAST/totalMatrix_WHAR_20100601_3ch_3month/newSP_waveforms/'
...
#input_dir = '../../data/OutputFAST/totalMatrix_WHAR_20100801_3ch_1month/'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs8_ntbls100_nvotes4_thresh0.16_catalog_timewin4.txt'
...
#input_dir = '../../data/OutputFAST/totalMatrix_WHAR_20100601_3ch_1month/'
#input_file = 'compare_fast_wLen3_wLag0.03_fpLen64_fpLag10_tvalue800_nfuncs8_ntbls100_nvotes4_thresh0.5_catalog_timewin4.txt'
