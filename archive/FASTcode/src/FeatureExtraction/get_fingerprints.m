% Usage:
%  [binaryFingerprint] = get_fingerprints(stdHaarImages, t_value);
%
...
function [binaryFingerprint, partRuntime] = get_fingerprints(stdHaarImages, t_value)
% function [topWaveletImages, binaryFingerprint, partRuntime] = get_fingerprints(stdHaarImages, t_value) % debug
